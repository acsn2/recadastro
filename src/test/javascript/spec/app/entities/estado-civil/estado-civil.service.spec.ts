...
describe('Service Tests', () => {
    describe('EstadoCivil Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstadoCivilService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-civils';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoCivil', () => {
                service.create(new EstadoCivil(null)).subscribe(received => {
            ...
            it('should update a EstadoCivil', () => {
                service.update(new EstadoCivil(123)).subscribe(received => {
            ...
            it('should return a EstadoCivil', () => {
