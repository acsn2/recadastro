...
describe('Service Tests', () => {
    describe('Escolaridade Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EscolaridadeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/escolaridades';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Escolaridade', () => {
                service.create(new Escolaridade(null)).subscribe(received => {
            ...
            it('should update a Escolaridade', () => {
                service.update(new Escolaridade(123)).subscribe(received => {
            ...
            it('should return a Escolaridade', () => {
            ...
            it('should return a list of Escolaridade', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Escolaridade(123)]);
            });
